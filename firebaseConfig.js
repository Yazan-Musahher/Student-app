...
import{addDoc, collection, getDoc, query, where, onSnapshot} from "firebase/firestore"
...
export {app, db, addDoc, collection, getFirestore, getDoc,query, where, onSnapshot}